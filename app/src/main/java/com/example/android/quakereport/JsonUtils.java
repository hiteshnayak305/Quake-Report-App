        ...
        */
        try {
            ...
            for (int i = 0; i < mainArray.length(); i++) {
                JSONObject property = mainArray.getJSONObject(i).getJSONObject("properties");
                ...
                String city = property.getString("place");

                String url = property.getString("url");
                items.add(new Item(mag, city, time, url));
            }
    ...
    static String makeHttpRequest(String urlString) {
        ...
        try {
            ...
            if (connection.getResponseCode() == 200) {
                ...
                jsonString = getJsonResponse(inputStream);
            } else {
                Log.e("JsonUtils", "Error getting response" + connection.getResponseCode());
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
